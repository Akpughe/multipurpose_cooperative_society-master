...
if($_SERVER["REQUEST_METHOD"] == "POST" ){
    ...
    if(mysqli_query($link,$query2) && mysqli_query($link,$query3)){
        if(mysqli_query($link,$query1)){
            echo '<div class="alert alert-success alert-dismissible">Registered Successfully</div>';
        }else{
